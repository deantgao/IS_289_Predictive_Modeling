...
def display_interpols(file, encoding):
	...
	est_1_miss = lin_interpol(file, encoding)[1]
	est_2_miss = nearest_interpol(file, encoding)[1]
	est_3_miss = vals_interpol(file, encoding)[1]
	est_4_miss = index_interpol(file, encoding)[1]
